...
export default {
  ...
  Ambulance: '[救护车]',
  Poop: '[便便]',
  clearChatHistoryText: '清空聊天记录',
  clearChatHistoryConfirmText: '确定要清空与对方的聊天记录吗？此操作不可恢复',
  clearText: '清空',
  clearingText: '清空中...',
  noMessagesToClearText: '暂无聊天记录可清空',
  clearChatHistorySuccessText: '聊天记录已清空',
  clearChatHistoryFailText: '清空聊天记录失败',
  clearAllSessionsText: '清空所有会话',
  clearAllSessionsConfirmText: '确定要清空所有会话吗？此操作不可恢复，但可以重新发起聊天',
  clearingAllSessionsText: '清空中...',
  noSessionsToClearText: '暂无会话可清空',
  clearAllSessionsSuccessText: '所有会话已清空',
  clearAllSessionsFailText: '清空所有会话失败',
}
