...
var wxRequestHelper = request$1;

var request = wxRequestHelper
    ;
...
var Storage = /** @class */ (function () {
    ...
    Storage.prototype.get = function (key) {
        ...
        switch (this.type) {
            ...
            case 'localStorage':
            case 'sessionStorage':
                value = wx.getStorageSync("".concat(this.salt).concat(key));
                return value;
        }
    };
    Storage.prototype.set = function (key, value) {
        switch (this.type) {
            ...
            case 'localStorage':
            case 'sessionStorage':
                wx.setStorageSync("".concat(this.salt).concat(key), value);
                break;
        }
    };
    Storage.prototype.remove = function (key) {
        switch (this.type) {
            ...
            case 'localStorage':
            case 'sessionStorage':
                wx.removeStorageSync("".concat(this.salt).concat(key));
                break;
        }
    };
    return Storage;
}());
var wxStorage = Storage;
...
var XKitReporter = /** @class */ (function () {
    function XKitReporter(options) {
        ...
        var appName = '';
        try {
            appName = document === null || document === void 0 ? void 0 : document.title;
        }
        catch (_b) { }
        this.common = {
...
export { EventPriority, EventStep, EventTracking$1 as EventTracking, IntervalEvent, ReportEvent, index as Storage, VisibilityObserver$1 as VisibilityObserver, XKitReporter$1 as XKitReporter, addUrlSearch, createLoggerDecorator, debounce, frequencyControl, getBrowserInfo, getFileType, getOperatingSystem, logDebug$1 as logDebug, parseFileSize, request };
