...
var _psychologicalAssessment = _interopRequireDefault(__webpack_require__(/*! ./pages/features/psychological-assessment.vue */ 104));
// @ts-ignore
...
/* harmony import */ var _psychological_assessment_vue_vue_type_template_id_57e36e83___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./psychological-assessment.vue?vue&type=template&id=57e36e83& */ 105);
/* harmony import */ var _psychological_assessment_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./psychological-assessment.vue?vue&type=script&lang=js& */ 107);
...
/* harmony import */ var _psychological_assessment_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./psychological-assessment.vue?vue&type=style&index=0&lang=css& */ 109);
...
var render = function () {
  ...
  var g0 = _vm.currentTab === 1 ? _vm.myReports.length : null
  var l0 =
    _vm.currentTab === 2
      ? _vm.__map(_vm.counselors, function (counselor, index) {
          var $orig = _vm.__get_orig(counselor)
          var g1 = counselor.rating.toFixed(1)
          return {
            $orig: $orig,
            g1: g1,
          }
      ...
      : null
  var g2 = _vm.showCounselorDetailPopup
...
var _default = {
  data: function data() {
    return {
      ...
      myReports: [{
        ...
        recommendations: ['保持规律的作息时间', '每天进行30分钟有氧运动', '学习简单的放松技巧', '与朋友保持社交联系']
      }, {
        id: 2,
        title: 'GAD-7 广泛性焦虑量表',
        date: '2023-05-10',
        ...
        recommendations: ['学习呼吸放松技巧', '尝试正念冥想练习', '识别并挑战消极思维', '考虑预约心理咨询']
      }],
      // 咨询师列表
      counselors: [{
        id: 1,
  ...
  methods: {
    ...
    // 选择时间
    selectTime: function selectTime(index, time) {
      if (time.available) {
    ...
    bookAppointment: function bookAppointment() {
      ...
      if (this.selectedTimeIndex >= 0) {
        ...
        var time = this.availableTimeSlots[this.selectedTimeIndex];
        uni.showModal({
          title: '预约确认',
          content: "\u60A8\u786E\u5B9A\u8981\u9884\u7EA6".concat(this.currentCounselor.name, "\u54A8\u8BE2\u5E08\u57285\u6708").concat(date.day, "\u65E5 ").concat(time.time, "\u7684\u54A8\u8BE2\u5417\uFF1F"),
